...
var newstr=document.getElementsByTagName("body")[0].innerHTML.replace(eval("/(<[b-zB-Z]{1}[^<>]*>[^<>]*)"+str+"([^<>]*<[a-zA-Z\\\/]{1}[^<>]*>)/ig"),"$1"+'<a name="tuilink_a_5dfe53e3dre3" href="http://www.tuiunion.com/tuilink/redirect/'+linkdata.id+'/?domain='+document.domain+'" title="'+linkdata.info+'"  target="_black" style="font-size:inherit !important">'+str+'</a>'+"$2");
